CREATE DATABASE `pitchfx` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;

CREATE TABLE `atbats` (
  `index` bigint(20) DEFAULT NULL,
  `retro_game_id` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `game_type` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `game_type_des` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `local_game_time` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `game_id` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_team_id` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `away_team_id` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_team_lg` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `away_team_lg` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `interleague_fl` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `park_id` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `pitch_type_seq` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
